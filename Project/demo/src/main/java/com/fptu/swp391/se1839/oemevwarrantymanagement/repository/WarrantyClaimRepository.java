...
public interface WarrantyClaimRepository extends JpaRepository<WarrantyClaim, Long> {
    ...
    List<WarrantyClaim> findByVehicleVinAndStatusNotIn(String vin, List<WarrantyClaim.ClaimStatus> statuses);

    long countByTechnicianIdAndStatus(Long technicianId, WarrantyClaim.ClaimStatus status);
