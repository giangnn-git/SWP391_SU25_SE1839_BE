...
public interface RepairOrderRepository extends JpaRepository<RepairOrder, Long> {
    ...
    @Query("SELECT COUNT(r.id) " +
            ...
            "WHERE (:serviceCenterId IS NULL OR t.serviceCenter.id = :serviceCenterId) " +
    ...
    long countRepairFlWeekAll(@Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
    ...
    long countRepairFlStatusAll(@Param("status") RepairOrder.OrderStatus status);
