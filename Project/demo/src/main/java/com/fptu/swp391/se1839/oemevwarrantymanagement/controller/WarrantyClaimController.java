...
public class WarrantyClaimController {
        ...
        //                         serviceCenterId, attachments, userId);
        ...
        public ResponseEntity<ApiResponse<CreateClaimResponse>> createClaim(
                ...
                var warrantyClaim = warrantyClaimService.handleCreateClaim(request, serviceCenterId, null, userId);
                var result = ApiResponse.<CreateClaimResponse>builder()
                        .status(HttpStatus.OK.toString())
                        .message("Create claim successfully")
                        .data(warrantyClaim)
        ...
        public ResponseEntity<ApiResponse<ClaimDetailResponse>> getClaimDetail(@PathVariable("id") long claimId,
                ...
                var result = ApiResponse.<ClaimDetailResponse>builder()
                                .status(HttpStatus.OK.toString())
                                .message("Gtet claim detail successfully")
                                .data(detail)
                                .build();
                return ResponseEntity.ok(result);
        }
